...
<html class="no-js">
    <head>  
        ...
        <meta property="og:image" content="https://aksharmty.in/ram-shalaka.jpg">
...
<?php include"menu.html"?>
 ...
 <?php
$id=$_GET['id'];
if($id == "1" ) {$ques = "चौपाई :	उघरहिं अंत न होइ निबाहू। कालनेमि जिमि रावन राहू॥";
$ans ="अर्थ:यह चौपाई बालकाण्ड के आरम्भ की है। कार्य की सफलता मे संदेह है।\r\n";}

if($id == "2" ) {$ques = "चौपाई :गरल सुधा रिपु करहिं मिताई। गोपद सिंधु अनल सितला";
$ans = 'अर्थ:यह चौपाई सुन्दरकाण्ड मे हनुमान जी के लंका मे प्रवेश करने के समय की है। प्रश्न बहुत श्रेष्ठ है कार्य सिद्ध होगा।';}

if($id == "3" ) {$ques = "चौपाई :	प्रबिसि नगर कीजे सब काजा। हृदय राखि कोसलपुर राजा॥";
$ans = 'अर्थ:	यह चौपाई सुन्दरकाण्ड मे हनुमान जी के लंका मे प्रवेश करने के समय की है। अर्थ यह है कि भगवान के नाम का स्मरण करते हुये कार्य शुरू करें सफलता मिलेगी।';}

if($id == "4" ) {$ques = "चौपाई :	बिधि बस सुजन कुसंगत परहीं। फनि मनि सम निज गुन अनुसरहीं॥";
$ans = 'अर्थ:	यह चौपाई बालकाण्ड के आरम्भ की है। अर्थ यह है कि बुरे लोगों का संग छोड़ दें कार्य की सफलता मे संदेह है।';}

if($id == "5" ) {$ques = "चौपाई :	मुद मंगलमय संत समाजू। जो जग जंगम तीरथ राजू॥";
$ans = 'अर्थ:	यह चौपाई बालकाण्ड मे संत समाजरुपी तीर्थ वर्णन मे आती है। अर्थ यह है कि कार्य सिद्ध होगा।';}

if($id == "6" ) {$ques = "चौपाई :	बरुन कुबेर सुरेस समीरा। रन सन्मुखधरि काहु न धीरा॥";
$ans = 'अर्थ:	यह चौपाई रावण वध पर मंदोदरी के विलाप के संदर्भ मे है। कार्य पूरा होने मे संदेह है।';}

if($id == "7" ) {$ques = "चौपाई :	सुनु सिय सत्य असीस हमारी। पूजहि मन कामना तुम्हारी॥";
$ans = 'अर्थ:	यह चौपाई बालकाण्ड मे सीता जी को गौरी जी का आशिर्वाद है। प्रश्न उत्तम है कार्य सिद्ध होगा।';}

if($id == "8" ) {$ques = "चौपाई :	सुफल मनोरथ हो हुँ तुम्हारे। रामु लखनु सुनि भए सुखारे॥";
$ans = 'अर्थ:	यह चौपाई विश्वामित्र का आशिर्वाद है। प्रश्न उत्तम है कार्य सिद्ध होगा।';}

if($id == "9" ) {$ques = "चौपाई : होइहि सोइ जो राम रचि राखा। को करितर्क बढ़ावै साखा॥";
$ans = 'अर्थ: यह चौपाई बालकाण्ड शिव पार्वती संवाद मे है। कार्य पूरा होने मे संदेह है। प्रभु पर छोड़ दें।';}
?>  
<table width="90%">
<?php
if($id > "0") {
?>
<tr><td width="80%"><h2><?php echo $ques; ?></h2></td></tr>
<tr><td width="80%"><h2><?php echo $ans; ?></h2><br></td></tr>
<?php
$i++;
}
